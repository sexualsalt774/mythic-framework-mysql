...
function FetchBillboardsData()
    ...
    MySQL.query('SELECT billboardId, billboardUrl FROM billboards', {}, function(results)
...
function SetBillboardURL(billboardId, url)
    ...
    MySQL.update('INSERT INTO billboards (billboardId, billboardUrl) VALUES (?, ?) ON DUPLICATE KEY UPDATE billboardUrl = VALUES(billboardUrl)', { billboardId, url }, function(affectedRows)
